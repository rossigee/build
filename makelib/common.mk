...
reviewable:
	...
	@(GOFLAGS=-mod=mod GOWORK=$$GOWORK $$HOME/go/bin/govulncheck ./... 2>&1 || true) | tee /tmp/govulncheck.out >/dev/null; rm -f $$GOWORK_DIR/go.work 2>/dev/null; rmdir $$GOWORK_DIR 2>/dev/null; \
